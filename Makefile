...
rpm: var/log/maitred
	/usr/local/share/gems/gems/fpm-1.4.0/bin/fpm -s dir -t rpm -n "maitred" --maintainer 'paulina.budzon@condenastint.com' --vendor 'condenastint' -v 0.2.0 -a all -C ./src/rhel --prefix / --config-files /etc/maitred.conf --depends git --depends psmisc .
